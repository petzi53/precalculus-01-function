...
To generate a soluton I could have used also [WolframAlpha](https://www.wolframalpha.com/).
...
::: {.callout-caution}
I got the impression that I need to refresh my knowledge about factoring `r glossary("Polynomial Math", "polynomials")` and solving of quadratic equations. So I registered with the Khan Academy and finished Unit 13 [Quadratics:Multiplying & Factoring](https://www.khanacademy.org/math/algebra/x2f8bb11595b61c86:quadratics-multiplying-factoring) of Algebra 1.
